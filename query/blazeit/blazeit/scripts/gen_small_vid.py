...
def main():
    ...
    parser.add_argument('--data_path', default='/home/inkosizhong/Lab/VideoQuery/datasets/')
    parser.add_argument('--out_dir', default='/home/inkosizhong/Lab/VideoQuery/datasets/resol-65/')

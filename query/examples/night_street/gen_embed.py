...
class NightStreetTiledIndex(Index):
...
class NightStreetTiledConfig(IndexConfig):
    def __init__(self):
        super().__init__()
        self.cache_root = 'query/examples/night_street/cache'

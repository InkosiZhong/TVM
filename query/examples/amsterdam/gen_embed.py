...
class AmsterdamTiledIndex(Index):
    def get_target_dnn(self):
        model = YoloV5(model_capacity='yolov5m', scale_factor=1).cuda()
        return model
...
class AmsterdamTiledConfig(IndexConfig):
    def __init__(self):
        super().__init__()
        self.cache_root = 'query/examples/amsterdam/cache/'
